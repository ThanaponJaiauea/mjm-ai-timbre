...
export const PromptInput = ({
  ...
  return (
    <AttachmentsContext.Provider value={ctx}>
      ...
      />
      <form
        className={cn("w-full divide-y overflow-hidden rounded-[17px] border bg-background shadow-sm", className)}
...
export const PromptInputTextarea = ({
  ...
  return (
    <Textarea
      className={cn(
        "w-full resize-none rounded-none border-none pt-[17px] pl-10 shadow-none outline-none ring-0",
...
export const PromptInputSubmit = ({
  ...
  // let Icon = <SendIcon className="size-4 text-[#A2A2A2]" />;
